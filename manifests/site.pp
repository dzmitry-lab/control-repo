...
node slave1.puppet {
  ...
  file { '/etc/httpd/conf.d/01-demosite-static.conf':
    ...
    source => 'puppet:///modules/dev_env/apache_conf/01-demosite-static.conf',
    replace => true,
      } 
...
#      } 
  ...
  file { '/var/www/01-demosite-static/index.html':
    ...
    source => 'puppet:///modules/dev_env/01-demosite-static/index.html'
}
}
...
node slave2.puppet {
  ...
  file { '/etc/httpd/conf.d/01-demosite-php.conf':
	...
	notify  => Service['httpd'],
    source => 'puppet:///modules/dev_env/apache_conf/01-demosite-php.conf',
    replace => true,
      } 
...
#      }
  file { '/var/www/01-demosite-php/index.php':
    ...
    source => 'puppet:///modules/dev_env/01-demosite-php/index.php'
}
}
